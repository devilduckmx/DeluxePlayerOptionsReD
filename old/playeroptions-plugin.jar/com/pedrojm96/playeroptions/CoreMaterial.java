...
public class CoreMaterial {
    ...
    public static Material getMaterial(int id) {
        if (CoreVersion.getVersion().esMenorIgual(CoreVersion.v1_12_x)) {
            return Material.getMaterial((String)idpre113.get(id));
        }
        return Material.getMaterial((String)idpos113.get(id));
    }

    public static Material getMaterial(String mate) {
        try {
            return Material.valueOf((String)mate);
        }
    ...
    public static boolean isMaterial(Material material, String ... mates) {
        ...
        while (i < mates.length) {
            String mate = mates[i].trim();
            if (material == CoreMaterial.getMaterial(mate)) {
                return true;
            }
            ++i;
        }
    ...
    public static ItemStack createItem(String name, List<String> lore, String mate, int shrt) {
        ItemStack i = new ItemStack(Material.getMaterial((String)mate), 1, (short)shrt);
        ItemMeta im = i.getItemMeta();
