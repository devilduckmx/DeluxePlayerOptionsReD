...
extends CorePluginCommand {
    ...
    public CommandJump(PlayerOptions plugin) {
        this.plugin = plugin;
        plugin.log.info("Register command /jump");
    }
    ...
    public boolean onCommand(CommandSender sender, String command, String[] args) {
        ...
        Option options = this.plugin.options.get("jump");
    ...
    public String getErrorNoPermission() {
        return String.valueOf(AllString.prefix) + AllString.no_permission_jump;
    }

    @Override
    public String getPerm() {
        return "playeroptions.jump";
    }
    ...
    public String getDescription() {
        return "PlayerOptions Jump command";
    }
}
