...
extends CorePluginCommand {
    ...
    public CommandRadio(PlayerOptions plugin) {
        this.plugin = plugin;
        plugin.log.info("Register command /radio");
    }
    ...
    public boolean onCommand(CommandSender sender, String command, String[] args) {
        ...
        Option options = this.plugin.options.get("radio");
    ...
    public String getErrorNoPermission() {
        return String.valueOf(AllString.prefix) + AllString.no_permission_radio;
    }

    @Override
    public String getPerm() {
        return "playeroptions.radio";
    }
    ...
    public String getDescription() {
        return "PlayerOptions radio command";
    }
}
