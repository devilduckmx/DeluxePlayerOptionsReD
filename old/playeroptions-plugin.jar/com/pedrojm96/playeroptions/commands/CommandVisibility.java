...
extends CorePluginCommand {
    ...
    public CommandVisibility(PlayerOptions plugin) {
        this.plugin = plugin;
        plugin.log.info("Register command /visibility");
    }
    ...
    public boolean onCommand(CommandSender sender, String command, String[] args) {
        ...
        Option options = this.plugin.options.get("visibility");
    ...
    public String getErrorNoPermission() {
        return String.valueOf(AllString.prefix) + AllString.no_permission_visibility;
    }

    @Override
    public String getPerm() {
        return "playeroptions.visibility";
    }
    ...
    public String getDescription() {
        return "PlayerOptions visibility command";
    }
}
