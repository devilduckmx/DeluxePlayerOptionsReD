...
public class CommandStacker
extends CorePluginCommand {
    private PlayerOptions plugin;

    public CommandStacker(PlayerOptions plugin) {
        this.plugin = plugin;
        plugin.log.info("Register command /stacker");
    }
    ...
    public boolean onCommand(CommandSender sender, String command, String[] args) {
        ...
        Option options = this.plugin.options.get("stacker");
    ...
    public String getErrorNoPermission() {
        return String.valueOf(AllString.prefix) + AllString.no_permission_stacker;
    }

    @Override
    public String getPerm() {
        return "playeroptions.stacker";
    }
    ...
    public String getDescription() {
        return "PlayerOptions stacker command.";
    }
}
