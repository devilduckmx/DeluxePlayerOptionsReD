...
extends CorePluginCommand {
    ...
    public CommandFly(PlayerOptions plugin) {
        this.plugin = plugin;
    ...
    public boolean onCommand(CommandSender sender, String command, String[] args) {
        ...
        Option options = this.plugin.options.get("fly");
    ...
    public String getErrorNoPermission() {
        return String.valueOf(AllString.prefix) + AllString.no_permission_fly;
    }

    @Override
    public String getPerm() {
        return "playeroptions.fly";
    }
    ...
    public String getDescription() {
        return "PlayerOptions Fly command.";
    }
}
