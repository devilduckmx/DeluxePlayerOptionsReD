...
public class CommandDoubleJump
extends CorePluginCommand {
    private PlayerOptions plugin;

    public CommandDoubleJump(PlayerOptions plugin) {
        this.plugin = plugin;
        plugin.log.info("Register command /doublejump");
    }
    ...
    public boolean onCommand(CommandSender sender, String command, String[] args) {
        ...
        Option options = this.plugin.options.get("doublejump");
    ...
    public String getErrorNoPermission() {
        return String.valueOf(AllString.prefix) + AllString.no_permission_doublejump;
    }

    @Override
    public String getPerm() {
        return "playeroptions.doublejump";
    }
    ...
    public String getDescription() {
        return "PlayerOptions Double Jump command";
    }
}
