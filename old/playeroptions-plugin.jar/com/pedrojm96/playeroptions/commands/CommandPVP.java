...
extends CorePluginCommand {
    ...
    public CommandPVP(PlayerOptions plugin) {
        this.plugin = plugin;
        plugin.log.info("Register command /fly");
    }
    ...
    public boolean onCommand(CommandSender sender, String command, String[] args) {
        ...
        Option options = this.plugin.options.get("pvp");
    ...
    public String getErrorNoPermission() {
        return String.valueOf(AllString.prefix) + AllString.no_permission_pvp;
    }

    @Override
    public String getPerm() {
        return "playeroptions.pvp";
    }
    ...
    public List<String> getAliases() {
        return Arrays.asList("playervsplayer", "JcJ");
    }
    ...
    public String getDescription() {
        return "PlayerOptions PvP command.";
    }
}
